...
class DiagnosisKeyConstantsTest {
    ...
    fun allDiagnosisKeyConstants() {
        ...
        Assert.assertEquals(
            DiagnosisKeyConstants.DIAGNOSIS_KEYS_DOWNLOAD_URL,
        ...
        Assert.assertEquals(
            DiagnosisKeyConstants.PARAMETERS_COUNTRY_DOWNLOAD_URL,
            "version/v1/parameters/country"
        )
        Assert.assertEquals(
            DiagnosisKeyConstants.APPCONFIG_COUNTRY_DOWNLOAD_URL,
        ...
        Assert.assertEquals(
            ...
            "version/v1/diagnosis-keys/country/BE/date"
        )
    }
}
