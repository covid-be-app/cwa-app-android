...
class DefaultRiskLevels : RiskLevels {
    ...
    override fun calculateRisk(
        ...
        if (dropDueToTransmissionRiskLevel(
                transmissionRiskLevel,
                appConfig.transmissionRiskLevelFilters
            )
        ) {
            Timber.d(
    ...
    override fun aggregateResults(
        ...
        Timber.d(
            "totalMinimumDistinctEncountersWithLowRisk: %d",
        ...
        Timber.d(
            "totalMinimumDistinctEncountersWithHighRisk: %d",
